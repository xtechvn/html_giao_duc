...
var rootDir = mobile == true ? "Mobile" : "PC";
...
gulp.task("build-template", function () {
  return gulp.src(rootDir + '/src/pages/*.html')
    .pipe(template(rootDir + '/src/template/main.html'))
...
gulp.task('watch', function () {
  ...
  gulp.watch(rootDir + '/src/**/*.html', ['build-template']);
